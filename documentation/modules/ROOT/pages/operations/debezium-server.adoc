...
|
|A number in the range 0..15 used for selecting the database to work with. Defaults is database 0. This feature is only available for standalone Redis connections; Redis clusters use only database 0.
